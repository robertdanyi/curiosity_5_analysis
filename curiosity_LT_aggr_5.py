...
def aggregate_data(ord_dict):
    ...
    for key, value in ord_dict.items():
        ...
        df_int.loc[key, test_cols] = test_df.loc[0, test_cols]
        df_int.loc[key, gaze_cols] = gaze_df.loc[0, gaze_cols]
        
        df_bor.loc[key, test_cols] = test_df.loc[1, test_cols]
        df_bor.loc[key, gaze_cols] = gaze_df.loc[1, gaze_cols]
...
#                                       columns=c.quant_columns, index=["interesting", "other"])
